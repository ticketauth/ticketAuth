		...
		<SimpleGrid columns={6} spacing={4} w="100%">
			...
			<GridItem colSpan={[6, 2]}>
				<FormControl w="100%" isInvalid={data.Category == ""}>
					...
					/>
					{data.Category == "" && (
						<FormErrorMessage>Enter the event category.</FormErrorMessage>
					)}
				</FormControl>
			</GridItem>
			...
			<GridItem colSpan={[6, 3]}>
				<FormControl w="100%" isInvalid={data["Start Event Datetime"] == ""}>
					...
					<Input
						...
						onChange={(e) =>
							handleData("Start Event Datetime", e.currentTarget.value)
						}
					/>
					{data["Start Event Datetime"] == "" && (
			...
			<GridItem colSpan={[6, 3]}>
				<FormControl w="100%" isInvalid={data["End Event Datetime"] == ""}>
					...
					<Input
						...
						onChange={(e) =>
							handleData("End Event Datetime", e.currentTarget.value)
						}
					/>
					{data["End Event Datetime"] == "" && (
						<FormErrorMessage>Date is required.</FormErrorMessage>
			...
			<GridItem colSpan={[6, 1]}>
				<FormControl
					w="100%"
					isInvalid={data["Event Capacity"].toString() == ""}
				>
					...
					<Input
						...
						onChange={(e) =>
							handleData("Event Capacity", e.currentTarget.value)
						}
						w="100%"
					/>
			...
			<GridItem colSpan={[6, 2]}>
				<FormControl w="100%" isInvalid={data.Organizer == ""}>
					...
					/>
					{data.Organizer == "" && (
						<FormErrorMessage>Enter your Organizer name</FormErrorMessage>
					)}
				</FormControl>
			</GridItem>
			<GridItem colSpan={[6, 2]}>
				<FormControl w="100%" isInvalid={data["Organizers Email"] == ""}>
					...
					<Input
						...
						onChange={(e) =>
							handleData("Organizers Email", e.currentTarget.value)
						}
						w="100%"
					/>
		...
		<VStack w="100%" align="flex-start">
			<FormControl isInvalid={data["Event Description"] == ""}>
				...
				<Textarea
					...
					onChange={(e) =>
						handleData("Event Description", e.currentTarget.value)
					}
					w="100%"
				/>
				{data["Event Description"] == "" && (
