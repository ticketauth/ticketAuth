import { Button, Center, Flex, FormControl, FormErrorMessage, FormLabel, Grid, GridItem, Heading, Hide, HStack, Image, Input, Show, SimpleGrid, Spacer, Spinner, Tab, TabList, TabPanel, TabPanels, Tabs, Text, Textarea, VStack } from "@chakra-ui/react";
...
const CreateEvent: React.FC = () => {
  ...
  return (
		<Grid w='100%'>
			...
			<VStack spacing={-8}>
				<Backdrop>
					<Text fontSize={['5xl','6xl']} fontFamily={'monoton'} color='white'>Create Event</Text>
				</Backdrop>
