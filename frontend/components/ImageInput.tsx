...
export const ImageInput:React.FC<{data:FormInputData,handleData:(type:string,value:string)=>void,imgtype:string,setTicketFile:(File)=>void}> = ({data,handleData,imgtype,setTicketFile}) => {
